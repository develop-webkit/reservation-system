...
export const ROLE_COLORS = {
  ...
  [ROLES.MANAGER]: '#f5222d',      // Red (same as admin)
  [ROLES.EMPLOYEE]: '#faad14',     // Orange
  [ROLES.CUSTOMER]: '#52c41a',     // Green
};

// Full admin permissions list (reused for both 'admin' and 'manager' roles)
...
export const ROLE_PERMISSIONS = {
  // 'admin' - primary role value returned by the backend for administrators
  [ROLES.SUPER_ADMIN]: ADMIN_PERMISSIONS,
  // 'manager' - legacy/alternative admin role value
  [ROLES.MANAGER]: ADMIN_PERMISSIONS,
