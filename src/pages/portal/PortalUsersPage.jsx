import { Alert, Button, Card, Descriptions, Form, Input, Modal, Space, Tag, Typography, message } from 'antd';
    ...
    <div style={{ padding: 24, maxWidth: 700 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
        <div>
          ...
          <Text type="secondary">View your account details and security settings.</Text>
        </div>
      ...
      <Card>
        ...
        <Descriptions column={1} bordered size="small">
          ...
          <Descriptions.Item label="Linked Client">{currentUser?.linkedClientNo || '—'}</Descriptions.Item>
          <Descriptions.Item label="Client Account">{currentClient?.clientName || currentClient?.clientNo || '—'}</Descriptions.Item>
        </Descriptions>
