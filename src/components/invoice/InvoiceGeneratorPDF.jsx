...
const S = StyleSheet.create({
  ...
  infoLabel: { fontFamily: 'Helvetica-Bold', width: 98 },
  infoValue: { flex: 1 },
  // Table
  table: { marginTop: 14 },
      ...
      <Page size="A4" style={S.page}>
        ...
        <View style={S.bodyRow}>
          ...
          <View style={S.infoBox}>
            ...
            <InfoRow label="Start Date" value={fd(invoice.arriveDate)} />
            <InfoRow label="End Date" value={fd(invoice.departDate)} />
            <InfoRow label="Voucher No" value={invoice.voucherNo || '—'} />
            <InfoRow label="Rate" value={invoice.accountNo || '—'} />
            <InfoRow label="Duration" value={invoice.reservationNo || '—'} />
            <InfoRow label="Invoice Generated By" value={invoice.cashierName} />
        ...
        <View style={S.totalsOuter}>
          ...
          {voucherDiscount > 0 && (
            <View style={S.totalRow}>
              <Text style={[S.totalLabel, S.totalDanger]}>Voucher Discount</Text>
              <Text style={[S.totalValue, S.totalDanger]}>-${fm(voucherDiscount)}</Text>
            </View>
          )}
